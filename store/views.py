...
class CustomerViewSet(ModelViewSet):
    ...
    @action(detail=False, methods=['GET','PUT'], permission_classes=[IsAuthenticated])#action availalbe only for list
    def me(self, request):
...
class OrderViewSet(ModelViewSet):
    ...
    def get_queryset(self):
        ...
        customer_id=Customer.objects.only('id').get(user_id=self.user.id)
